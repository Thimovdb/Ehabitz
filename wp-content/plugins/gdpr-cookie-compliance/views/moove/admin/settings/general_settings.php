...
<form action="?page=moove-gdpr&amp;tab=general_settings" method="post" id="moove_gdpr_tab_general_settings">
    ...
    <table class="form-table">
        <tbody>
            ...
            <tr>
                <th scope="row">
                    <label for="moove_gdpr_plugin_font_family"><?php _e('Choose font-family','moove-gdpr'); ?></label>
                </th>
                <td>
                    <input name="moove_gdpr_plugin_font_family" type="text" id="moove_gdpr_plugin_font_family" value="<?php echo isset( $gdpr_options['moove_gdpr_plugin_font_family'] ) && $gdpr_options['moove_gdpr_plugin_font_family'] ? $gdpr_options['moove_gdpr_plugin_font_family'] : "'Nunito', sans-serif"; ?>" class="regular-text">
                    <p class="description" id="moove_gdpr_plugin_font_family-description" style="max-width: 25em;"><?php _e('You can use "inherit" value to inherit the font from parent (theme) or you can setup the font family for GDPR infobar and modal.','moove-gdpr'); ?></p>
                </td>
            </tr>
    ...
    <table class="form-table">
        <tbody>
            ...
            <tr>
                <th scope="row">
                    <label for="moove_gdpr_infobar_position"><?php _e('Info bar position','moove-gdpr'); ?></label>
                </th>
                <td>
                    
                    <input name="moove_gdpr_infobar_position" type="radio" value="top" id="moove_gdpr_infobar_position_top" <?php echo isset( $gdpr_options['moove_gdpr_infobar_position'] ) ? ( $gdpr_options['moove_gdpr_infobar_position'] === 'top' ? 'checked' : '' ) : ''; ?> class="regular-text on-top"> <label for="moove_gdpr_infobar_position_top"><?php _e('Top','moove-gdpr'); ?></label> <span class="separator"></span>

                    <input name="moove_gdpr_infobar_position" type="radio" value="bottom" id="moove_gdpr_infobar_position_bottom" <?php echo isset( $gdpr_options['moove_gdpr_infobar_position'] ) ? ( $gdpr_options['moove_gdpr_infobar_position']  === 'bottom' ? 'checked' : '' ) : 'checked'; ?> class="regular-text on-off"> <label for="moove_gdpr_infobar_position_bottom"><?php _e('Bottom','moove-gdpr'); ?></label>
