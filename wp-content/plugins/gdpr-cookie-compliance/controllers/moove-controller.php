...
class Moove_GDPR_Controller {
    ...
    public function moove_gdpr_cookie_popup_modal() {
        ...
        <div class="moove-gdpr-company-logo-holder">
            ...
            ?>
            <img src="<?php echo $logo_url; ?>" alt="<?php echo gdpr_get_logo_alt( $logo_url ); ?>" class="img-responsive" />
        </div>
    ...
    public function moove_gdpr_cookie_popup_info() {
        ...
        ob_start(); ?>
        <div id="moove_gdpr_cookie_info_bar" class="moove-gdpr-info-bar-hidden moove-gdpr-align-center <?php echo $scheme_class; ?> <?php echo 'gdpr_infobar_postion_' . $infobar_position; ?>">
