...
<form action="?page=moove-gdpr&amp;tab=advanced_cookies" method="post" id="moove_gdpr_tab_advanced_cookies">
    ...
    <table class="form-table <?php echo $empty_scripts ? 'moove-gdpr-form-error' : ''; ?>">
        <tbody>
            ...
            <tr>
                <th scope="row">
                    <label for="moove_gdpr_advanced_cookies_enable_first_visit"><?php _e('Enable by default','moove-gdpr'); ?></label>
                </th>
                <td>
                    <input name="moove_gdpr_advanced_cookies_enable_first_visit" type="radio" value="0" id="moove_gdpr_advanced_cookies_enable_first_visit_off" <?php echo isset( $gdpr_options['moove_gdpr_advanced_cookies_enable_first_visit'] ) ? ( intval( $gdpr_options['moove_gdpr_advanced_cookies_enable_first_visit'] ) === 0  ? 'checked' : '' ) : 'checked'; ?> class="regular-text on-off"> <label for="moove_gdpr_advanced_cookies_enable_first_visit_off"><?php _e('Disable','moove-gdpr'); ?></label> <span class="separator"></span>
                    
                    <input name="moove_gdpr_advanced_cookies_enable_first_visit" type="radio" value="1" id="moove_gdpr_advanced_cookies_enable_first_visit_on" <?php echo isset( $gdpr_options['moove_gdpr_advanced_cookies_enable_first_visit'] ) ? ( intval( $gdpr_options['moove_gdpr_advanced_cookies_enable_first_visit'] ) === 1  ? 'checked' : '' ) : ''; ?> class="regular-text on-off"> <label for="moove_gdpr_advanced_cookies_enable_first_visit_on"><?php _e('Enable','moove-gdpr'); ?></label>
                </td>
            </tr>
